...
async function handleClickEditButton(bookId) {
  try {
    ...
    currentBook = await response.json(); // simpan hasilnya ke variabel currentBook
...
async function loadPage() {
  switch (currentPage) {
    case 'home':
      ...
      const rows = generateRows(books); // Panggil function generateRows dengan parameter books
      ...
      const formInput = generateEditFormInput(); // Panggil function generateEditFormInput
